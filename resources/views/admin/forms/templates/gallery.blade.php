...
$wrapper->{MODEL_PRIMARY_KEY} .= '-block';
$input->multiple = 'true';
$input->accept="image/*";
$input->name.='[]';
    ...
    <div class="gallery-hidden-input-group d-none">
        @if (count($gallery))
            @foreach ($gallery as $file)
                <input type="hidden" name="{{$baseName.'[]'}}" value="{{$file->{MODEL_PRIMARY_KEY} }}" id="hidden-input-gallery-image-{{$file->{MODEL_PRIMARY_KEY} }}">
            @endforeach
        @endif
    </div>
    ...
    <div class="gallery-images">
        @if (count($gallery))
            @foreach ($gallery as $file)
                ...
                <div class="dz-preview dz-image-preview" id="input-gallery-image-{{$file->{MODEL_PRIMARY_KEY} }}">
                    <div class="dz-image">
                    ...
                    <a class="dz-remove btn-remove-file" data-id="{{$file->{MODEL_PRIMARY_KEY} }}" href="javascript:undefined;">
